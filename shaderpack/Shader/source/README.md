...
- Voxy Face Flatten уменьшает текстурный шум дальних LOD выборкой цвета центра атласного тайла.
- Дальняя native-вода плавно теряет текстурные детали в диапазоне 50–160 блоков, сближаясь с представлением DH.
